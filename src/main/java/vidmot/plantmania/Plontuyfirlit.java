...
/*
class Rodun implements Comparator<Planta> { //setja public fremst og í sér klasa
    private Comparator<Planta> stafrofsrodComparator;
    private Comparator<Planta> ofugStafrofsrodComparator;

    public Rodun() {
        skilgreinaComparatora();
    ...
    private void skilgreinaComparatora() {
        stafrofsrodComparator = new Comparator<Planta>() {
            //public int compare(Planta o1, Planta o2) {
            //return o1.getAlmenntNafn().compareTo(o2.getAlmenntNafn());
                return
        ...
        ofugStafrofsrodComparator = new Comparator<Planta>() {
            public int compare(Planta o1, Planta o2) {
                //return o2.getAlmenntNafn().compareTo(o1.getAlmenntNafn());
                return compare(o1, o2);
            }
        };
    }

    public int compareRett(Planta o1, Planta o2) {
        String n1 = o1.getAlmenntNafn().toLowerCase();
        String n2 = o2.getAlmenntNafn().toLowerCase();

        return n1.compareTo(n2);
    }

    private void rada(ObservableList<Planta> listi, Comparator<Planta> regla) {
        Collections.sort(listi, regla);
    }
